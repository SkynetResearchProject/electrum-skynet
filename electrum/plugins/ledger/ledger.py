...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Skynet-coin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Skynet-coin mode")) from e
                raise e
